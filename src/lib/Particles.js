...
const preload = () => {
    ...
    const font = loader.load(
        "/fonts/Noto_Sans_KR_SemiBold_Regular.json",
        function (font) {
            typo = font;
        }
    );
...
class CreateParticles {
    ...
    calculateMobile() {
        ...
        if (screenWidth > mobileLargeThreshold) {
            ...
            (this.data.particleColor = 0xffffff), (this.data.textSize = 10);
            this.data.area = 250;
            this.data.ease = 0.05;
            ...
            (this.data.particleColor = 0xffffff), (this.data.textSize = 6);
            this.data.area = 100;
            this.data.ease = 0.04;
        } else {
            // isMobileSmall
            ...
            (this.data.particleColor = 0xffffff), (this.data.textSize = 4.5);
            this.data.area = 25;
            this.data.ease = 0.03;
        }
    }
    ...
    createText() {
        ...
        const material = new THREE.ShaderMaterial({
            uniforms: {
                color: { value: new THREE.Color(0xdeaded) },
